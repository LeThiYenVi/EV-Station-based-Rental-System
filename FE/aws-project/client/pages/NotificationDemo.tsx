      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="p-6 rounded-lg border bg-white shadow-sm">
            <h3 className="font-semibold mb-4 text-green-600">Success Notifications</h3>
            <Button 
          ...
          <div className="p-6 rounded-lg border bg-white shadow-sm">
            <h3 className="font-semibold mb-4 text-red-600">Error Notifications</h3>
            <Button 
          ...
          <div className="p-6 rounded-lg border bg-white shadow-sm">
            <h3 className="font-semibold mb-4 text-yellow-600">Warning Notifications</h3>
            <Button 
          ...
          <div className="p-6 rounded-lg border bg-white shadow-sm">
            <h3 className="font-semibold mb-4 text-blue-600">Info Notifications</h3>
            <Button 
          ...
          <div className="p-6 rounded-lg border bg-white shadow-sm">
            <h3 className="font-semibold mb-4 text-purple-600">Custom Notifications</h3>
            <Button 
