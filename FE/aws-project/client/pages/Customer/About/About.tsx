        ...
        <div className="company-content">
          <div className="company-text">
            ...
            <p>
              ...
              nghiệp và đáng tin cậy, BF Car Rental đã phục vụ hàng nghìn khách
              hàng trên khắp Việt Nam với cam kết về chất lượng và sự hài lòng.
            </p>
            ...
            <div className="company-info">
              <div className="info-card">
                ...
                <p>
                  Tòa Symphony, Chu Huy Mân, Vinhomes Riverside, Long Biên, Hà
                  Nội, Việt Nam
                </p>
              </div>
        ...
        <div className="container">
          <div className="history-content">
            <div className="history-header">
              ...
              <p>
                Từ một startup nhỏ đến thương hiệu cho thuê xe hàng đầu Việt Nam
              </p>
            </div>
            ...
            <div className="timeline">
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Khởi nghiệp</h3>
                  <p>
                    Thành lập công ty với 5 xe đầu tiên và đội ngũ 3 người. Khởi
                    đầu từ dịch vụ đưa đón sân bay tại Hà Nội.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p>
                    Đạt mốc 50 xe và mở rộng dịch vụ thuê xe tự lái. Thu hút
                    được 1,000 khách hàng đầu tiên.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p>
                    Có mặt tại TP.HCM và Đà Nẵng. Đội xe tăng lên 100 chiếc với
                    đa dạng các loại xe cao cấp.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Công nghệ 4.0</h3>
                  <p>
                    Ra mắt ứng dụng di động và hệ thống đặt xe trực tuyến. Đạt
                    5,000 khách hàng thường xuyên.
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  ...
                  <p>
                    Đạt 200+ xe và phục vụ hơn 10,000 khách hàng. Nhận giải
                    thưởng "Thương hiệu tin cậy 2024".
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="testimonials-grid">
              <div className="testimonial-card">
                ...
                <p className="testimonial-text">
                  "Dịch vụ tuyệt vời! Xe sạch sẽ, tài xế thân thiện và chuyên
                  nghiệp. Tôi đã sử dụng dịch vụ nhiều lần và luôn hài lòng."
                </p>
              ...
              <div className="testimonial-card">
                ...
                <p className="testimonial-text">
                  "Thuê xe đám cưới tại BF Car Rental là quyết định đúng đắn. Xe
                  đẹp, giá hợp lý và đội ngũ hỗ trợ nhiệt tình."
                </p>
                <div className="testimonial-author">
                  <div className="author-info">
                    <h4>Trần Thị Lan</h4>
              ...
              <div className="testimonial-card">
                ...
                <p className="testimonial-text">
                  "Dịch vụ đưa đón sân bay rất chuyên nghiệp. Tài xế đến đúng
                  giờ, lái xe an toàn và giá cả phải chăng."
                </p>
                <div className="testimonial-author">
                  <div className="author-info">
                    <h4>Lê Minh Tuấn</h4>
        ...
        <div className="services-grid">
          ...
          <div className="service-card">
            ...
            <div className="service-content">
              ...
              <p>
                Thuê xe đám cưới, du lịch với nhiều mẫu xe cao cấp và hiện đại.
              </p>
          ...
          <div className="service-card">
            ...
            <div className="service-content">
              ...
              <p>
                Phục vụ các sự kiện lớn, hội nghị, tiệc cưới với đội xe chuyên
                nghiệp.
              </p>
            </div>
          </div>
          ...
          <div className="service-card">
            ...
            <div className="service-content">
              ...
              <p>
                Chương trình thuê dài hạn với quyền lợi đặc biệt và linh hoạt.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="drive-explore-content">
            <div className="text-content">
              ...
              <p className="mission">
                ...
                và các đối tác của BF Car Rental với nhiều kinh nghiệm về lĩnh
                vực cho thuê xe, công nghệ, bảo hiểm & du lịch sẽ mang đến cho
                hành trình của bạn thêm nhiều trải nghiệm mới lạ, thú vị cùng sự
          ...
          <div className="mioto-journey-content">
            ...
            <div className="journey-text-right">
              ...
              <p className="journey-mission">
                BF Car Rental là nền tảng chia sẻ ô tô, sứ mệnh của chúng tôi
                không chỉ dừng lại ở việc kết nối chủ xe và khách hàng một cách{" "}
                <strong>Nhanh chóng - An toàn - Tiện lợi</strong>, mà còn hướng
                đến việc truyền cảm hứng <strong>KHÁM PHÁ</strong> những điều
                mới lạ đến cộng đồng qua những chuyến đi trên nền tảng của chúng
                tôi.
              </p>
            </div>
          </div>
